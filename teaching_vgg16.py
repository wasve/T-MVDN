# -*- coding: UTF-8 -*-
"""================================================================
>> Project -> File  : act-main -> teaching_vgg16
>> IDE              : PyCharm
>> Author           : Wasve
>> Date             : 2024/12/25 16:37
>> Desc             : None
================================================================"""
import copy
...
img = cv.imread(r"E:\doctor\teaching_graps\act-main\train_val_kl_seed_0.png")
img = cv.resize(img, [224, 224])
img = torch.permute(torch.Tensor(img), (2, 0, 1))
img2 = copy.deepcopy(img)
input_1 = torch.stack([img, img2], dim=0)
print(vgg())
